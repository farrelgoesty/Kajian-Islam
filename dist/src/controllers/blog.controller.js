...
exports.blogController = {
    async home(req, res) {
        ...
        res.render("blog/home", {
            ...
            title: "Home",
            meta: {
                title: "Kajian Islam | Artikel SEO, Konten Editorial, dan Panduan Praktis",
                description: "Kajian Islam modern dengan artikel SEO, strategi konten, performance, dan desain admin yang rapi.",
    ...
    async category(req, res) {
        ...
        res.render("blog/archive", {
            ...
            title: category.name,
            meta: {
                title: `${category.name} | Kajian Islam`,
